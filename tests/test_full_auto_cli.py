...
class FullAutoCliTests(unittest.TestCase):
    ...
    def test_request_from_args_maps_runner_options(self):
        ...
        expected_options = {
                ...
                "msr_workflow": str(Path("workflows") / "video_ltxv_msr_1actor_1background_v4.json"),
                "ingredients_workflow": str(Path("workflows") / "video_ltxv_ingredients_audio_2stage_v6.json"),
