        ...
        self.assertEqual(
            {
                ...
                "msr_workflow": str(Path("workflows") / "video_ltxv_msr_1actor_1background_v2.json"),
                "ingredients_workflow": str(Path("workflows") / "video_ltxv_ingredients_audio_2stage_v4.json"),
