...
class ProjectCreateRequest:
    ...
    movie_hero_workflow: str = "workflows/image/image-model/image_t2i_startframe_krea_v1.json"
    movie_edit_workflow: str = "workflows/image/image-model/image_edit_flux2_klein_1ref_v1.json"
    movie_startframe_director_backend: str = "krea2"
    movie_director_workflow: str = "workflows/image/image-model/image_t2i_startframe_krea_v1.json"
    movie_mask_workflow: str = "workflows/image/image-model/image_mask_sam3_actor_regions_v1.json"
    movie_identity_repair_workflow: str = "workflows/image/image-model/image_repair_sdxl_ipadapter_identity_v1.json"
    movie_detail_workflow: str = "workflows/image/image-model/image_detail_easyuse_startframe_v1.json"
    ...
    movie_msr_workflow: str = "workflows/video/ltx_25/msr/msr_draft.json"
    movie_msr_i2v_workflow: str = "workflows/video/ltx_25/i2v/i2v_draft.json"
    movie_i2v_workflow: str = "workflows/video/ltx_25/i2v/i2v_draft.json"
