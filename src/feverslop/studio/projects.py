...
class ProjectCreateRequest:
    ...
    movie_msr_workflow: str = "workflows/video_default_ltxv_msr_1actor_1background_v2.json"
    movie_msr_i2v_workflow: str = "workflows/video_default_i2v_ltxv_msr_1actor_1background_v2.json"
