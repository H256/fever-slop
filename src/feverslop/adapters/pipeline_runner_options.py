...
RUNNER_ARGUMENTS = (
    ...
    ("concept_batch_size", ("--concept-batch-size",), {"type": int, "default": 4}),
    ...
    ("sequence_to_sheet_workflow", ("--sequence-to-sheet-workflow",), {"default": str(Path("workflows/sequence/minimax_h3") / "sequence_to_sheet_minimax_h3_i2va_v1.json")}),
    ...
    ("skip_stem_separation", ("--skip-stem-separation",), {"action": "store_true"}),
    ("skip_whisper", ("--skip-whisper",), {"action": "store_true"}),
    ("skip_beat_analysis", ("--skip-beat-analysis",), {"action": "store_true"}),
