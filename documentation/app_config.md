...
| `dspy_temperature` | number | `0.4` | Sampling temperature for non-H3 DSPy calls. Also the fallback for a task missing from a directly-passed partial `task_temperatures` dict. |
